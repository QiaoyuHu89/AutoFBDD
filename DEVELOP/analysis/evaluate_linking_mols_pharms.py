...
linker_pharm = json_dict['abs_dist'][2:]
...
for result in results_copy:
    ...
    if linker_mol is not None:
        ...
        dic_list.append(dic['NegIonizable'])
        dic_list.append(dic['PosIonizable'])
        dic_list.append(dic['Aromatic'])
        dic_list.append(dic['Hydrophobe'])
        dic_list.append(dic['LumpedHydrophobe'])
