# usage : python Mapping_eval.py PROTEIN N Probes
import sys
import os

dock_content = [
  "ligand_name                      gen_mols.mol2\n",
  "atom_model                       all\n",
...
doc_content = [
  ...
  "MIN_REAL_TRANS        -0.5  -0.5  -0.5  -0.58  -0.58  -0.58\n",
  "#Upper limitfor transition\n",
  "MAX_REAL_TRANS           0.5   0.5  0.5   0.58  0.58   0.58\n",
  "#Range for rotation\n",
  "RANGE_OF_ROTATE         -0.58   0.58\n",
...
for k in range(int(sys.argv[2])):
  ...
  dock_content[0] = f"ligand_name                  {probes}\n"
