  ...
  { 
    ...
    for(my $k = 0; $k < $ARGV[1]; $k++)
    {
     ...
     # print "part of the protein"."\n";
      my $lable = $k+1;
      my $dock_in = $ARGV[4];
      open(DOCK,"$dock_in")||die "can't open the out dock.in file:$!";
      ...
      open(DOUK,">$dock_in")||die "can't open the out dock.in file:$!";
